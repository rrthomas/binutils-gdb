...
enum {
    BEE_TRAP_LIBC_STRLEN,
    BEE_TRAP_LIBC_STRNCPY,
    BEE_TRAP_LIBC_STDIN,
    BEE_TRAP_LIBC_STDOUT,
    BEE_TRAP_LIBC_STDERR,
    BEE_TRAP_LIBC_O_RDONLY,
    BEE_TRAP_LIBC_O_WRONLY,
    BEE_TRAP_LIBC_O_RDWR,
    BEE_TRAP_LIBC_O_CREAT,
    BEE_TRAP_LIBC_O_TRUNC,
    BEE_TRAP_LIBC_OPEN,
    BEE_TRAP_LIBC_CLOSE,
    BEE_TRAP_LIBC_READ,
    BEE_TRAP_LIBC_WRITE,
    BEE_TRAP_LIBC_SEEK_SET,
    BEE_TRAP_LIBC_SEEK_CUR,
    BEE_TRAP_LIBC_SEEK_END,
    BEE_TRAP_LIBC_LSEEK,
    BEE_TRAP_LIBC_FDATASYNC,
    BEE_TRAP_LIBC_RENAME,
    BEE_TRAP_LIBC_REMOVE,
    BEE_TRAP_LIBC_FILE_SIZE,
    BEE_TRAP_LIBC_RESIZE_FILE,
    BEE_TRAP_LIBC_FILE_STATUS,

    BEE_TRAP_LIBC_ARGC = 0x100,
    BEE_TRAP_LIBC_ARGV,
};
