...
const bee_opc_info_t bee_inst_info[0x40] =
  {
    ...
    { (BEE_INSN_PUSHR << BEE_OP2_SHIFT) | BEE_OP_INSN,      "pushr" },
    { (BEE_INSN_POPR << BEE_OP2_SHIFT) | BEE_OP_INSN,       "popr" },
    { (BEE_INSN_DUPR << BEE_OP2_SHIFT) | BEE_OP_INSN,       "dupr" },
    ...
    { (BEE_INSN_GET_M0 << BEE_OP2_SHIFT) | BEE_OP_INSN,     "get_m0" },
    { (BEE_INSN_GET_MSIZE << BEE_OP2_SHIFT) | BEE_OP_INSN,  "get_msize" },
